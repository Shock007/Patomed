...
Route::middleware('auth.session')->group(function () {
    ...
    // NUEVAS RUTAS: Validar e Invalidar
    Route::patch('/pacientes/{id}/validar', [PacienteController::class, 'validar'])->name('pacientes.validar');
    Route::patch('/pacientes/{id}/invalidar', [PacienteController::class, 'invalidar'])->name('pacientes.invalidar');
